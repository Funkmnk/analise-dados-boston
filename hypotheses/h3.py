...
def validar_correlacao(var_independente, var_dependente, hipotese_parte):
    ...
    plt.grid(True)
    # plt.savefig(f'../plot/h3_grafico_dispersap_{var_independente}_vs_{var_dependente}.png')
    plt.show()
    
# Parte 1: PTRATIO vs MEDV (Negativa)
validar_correlacao('PTRATIO', 'MEDV', 'Parte 1')

# Parte 2: PTRATIO vs CRIM (Positiva)
validar_correlacao('PTRATIO', 'CRIM', 'Parte 2')

# Parte 3: PTRATIO vs DIS (Negativa)
validar_correlacao('PTRATIO', 'DIS', 'Parte 3')